...
public class ArrayLisMetTest
{
	ArrayListMet testObj = new ArrayListMet();
	ArrayListMet addObj = new ArrayListMet();
	...
	public void testAddStart()
	{
		...
		int[] resArr = {15,11,-22,33,44,-55,66,-77,-88,99,0};
		testObj.addStart(15);
	...
	{
		int[] resArr = {11,-22,33,44,-55,66,-77,-88,99,0,15};
		testObj.addEnd(15);
		assertArrayEquals(resArr, testObj.array);
	}
